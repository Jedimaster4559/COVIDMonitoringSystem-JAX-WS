            ...
            switch (inputSize) {
                case 1:
                    if (inputArray[0] == "start") {
                        ...
                        System.out.println("You didn't enter a valid command case 1. Please try again.");
                    }
                ...
                case 2:
                    if (inputArray[0] == "switch") {
                        if (inputArray[1] == "1") {
                            ...
                            System.out.println("You didn't enter a valid command case 2a. Please try again.");
                        }
                    }
                        ...
                        config.getRequestUpdatePort().requestUpdate();
                        //currentClass = model.getClassroombyId(currentClassId); NOT SURE IF I NEED THIS OR NOT
                    }

                    else {
                        System.out.println("You didn't enter a valid command case 2. Please try again.");
                    }
                ...
                case 3:
                    if (inputArray[0] == "add") {
                        ...
                        if (inputArray[1] == "on") {
                            ...
                            System.out.println("You didn't enter a valid command case 3a. Please try again.");
                            break;
                        }
                    }
                        ...
                        if (inputArray[1] == "on") {
                            ...
                            System.out.println("You didn't enter a valid command case 3b. Please try again.");
                            break;
                        }
                    }

                    else {
                        System.out.println("You didn't enter a valid command case 3. Please try again.");
                    }
                ...
                case 4:
                    if (inputArray[0] == "move") {
                        ...
                        if (inputArray[3] == "y") {
                            ...
                            System.out.println("You didn't enter a valid command case 4. Please try again.");
                            break;
                        }
                ...
                default:
                    System.out.println("You didn't enter a valid command case default. Please try again.");
            }
